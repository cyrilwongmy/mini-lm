...
def run_transformer_lm(
    ...
    transformer.norm.load_state_dict({"gain": weights["ln_final.weight"]})
...
def run_get_batch(
    ...
    """
    from mini_lm.nn import get_batch
...
def run_get_lr_cosine_schedule(
    ...
    """
    from mini_lm.nn import get_cosine_schedule_with_warmup
...
def run_save_checkpoint(
    ...
    """
    from mini_lm.nn import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from mini_lm.nn import load_checkpoint
...
def get_tokenizer(
    ...
    """
    return BpeModel(vocab, merges, special_tokens)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    bpe_model = tokenizer.do_train(input_path, vocab_size, special_tokens)
    return bpe_model.id_to_word, bpe_model.merges
