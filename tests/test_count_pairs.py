from mini_lm.bpe import BpeTrainer
...
def test_empty_words():
    ...
    pair_counts, where_to_update = tokenizer._count_pairs(words, counts)
...
def test_integration_with_tokenize_words():
    ...
    w2id = {}
    id2w = {}
    tokenizer._compute_alphabet(w2id, id2w)
    
    # Get words from tokenize_words
    words, counts = tokenizer._tokenize_words(wc, w2id)
